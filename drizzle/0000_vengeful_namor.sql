...
CREATE UNIQUE INDEX "product_collections_product_collection_idx" ON "product_collections" USING btree ("product_id","collection_id");--> statement-breakpoint
...
CREATE INDEX "product_images_product_variant_idx" ON "product_images" USING btree ("product_id","variant_id");--> statement-breakpoint
CREATE INDEX "product_variants_product_idx" ON "product_variants" USING btree ("product_id");--> statement-breakpoint
CREATE INDEX "product_variants_product_color_idx" ON "product_variants" USING btree ("product_id","color_id");--> statement-breakpoint
CREATE INDEX "product_variants_product_size_idx" ON "product_variants" USING btree ("product_id","size_id");--> statement-breakpoint
